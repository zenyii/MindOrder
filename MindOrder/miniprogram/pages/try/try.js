...
>>>>>>> 791fe53af310765c7b0703a4c515138988d7dae4
  ...
  onLoad: function (options) {
    ...
    app.onQuery('rooms', { roomNum: app.globalData.roomNum }, { meetingTime: true }).then(res => {
      let data = res.data[0];
      app.globalData.minute = `${Number(data.meetingTime) - 1}`;
